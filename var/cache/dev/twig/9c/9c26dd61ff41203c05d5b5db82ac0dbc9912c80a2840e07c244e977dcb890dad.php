...
<h5>Méssage de : <b>";
        ...
        echo " </b> Email :<b>";
        echo twig_escape_filter($this->env, (isset($context["Email"]) || array_key_exists("Email", $context) ? $context["Email"] : (function () { throw new Twig_Error_Runtime('Variable "Email" does not exist.', 2, $this->source); })()), "html", null, true);
        echo "</b></h5>
<h5>Méssage : </h5>";
        // line 3
        echo twig_escape_filter($this->env, (isset($context["Message"]) || array_key_exists("Message", $context) ? $context["Message"] : (function () { throw new Twig_Error_Runtime('Variable "Message" does not exist.', 3, $this->source); })()), "html", null, true);
        echo " 
";
